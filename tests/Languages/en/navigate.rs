...
fn parts_prefix_logarithm_with_base() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; in base; b")
}
...
fn parts_infix_power() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; in base; x")
}
...
fn parts_function_square_root() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; in root; x")
}
...
fn no_parts_prefix_unary_minus() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; b")
}
...
fn no_parts_prefix_limit() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; x")
}
...
fn no_parts_prefix_vector() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; v")
}
...
fn no_parts_infix_binomial() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; in part 1; 7")
}
...
fn no_parts_postfix_transpose() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; in transpose; cap m")
}
...
fn no_parts_nofix_set_of_reals() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoomed in all of the way; set of all real numbers")
}
...
fn no_intent_times_mrow() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoom in; 2")
}
...
fn no_intent_mi() -> Result<()> {
    ...
    "#;
    assert_zoom_in("ZoomIn", expr, "zoomed in all of the way; x")
}
